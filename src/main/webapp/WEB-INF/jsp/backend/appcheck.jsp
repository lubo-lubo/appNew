      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="checksave" method="post">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" id="size">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" id="number">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" id="select">
              <input type="text" class="form-control col-md-7 col-xs-12" 
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="appstatus">APP状态 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12" id="appstatus">
            	<input type="text" class="form-control col-md-7 col-xs-12" 
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" id="textarea">
              <textarea class="form-control col-md-7 col-xs-12" readonly="readonly"> 
              ${appInfo.appInfo}</textarea>
            </div>
          </div>
           <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pic">LOGO图片 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12" id="pic">
			 <c:choose> 
        ...
        <form class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="versionintro">版本简介 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12" id="versionintro">
