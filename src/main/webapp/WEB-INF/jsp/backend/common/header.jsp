                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> APP管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/app/list">APP审核</a></li>
                      <li><a href="javascript:;">广告推广</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> 用户管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/buser/list">后台用户管理</a></li>
                      <li><a href="javascript:;">开发者资质审核</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-bug"></i> 基础数据维护 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/data/list">数据字典</a></li>
                      <li><a href="${pageContext.request.contextPath }/appcategory/categorylist">APP分类管理</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
