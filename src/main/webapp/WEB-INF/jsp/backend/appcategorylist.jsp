...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    APP 分类列表 <i class="fa fa-user"></i><small>${userSession.userName}
                    - 您可以通过搜索或者其他的筛选项对APP的分类信息进行操作。^_^</small>
                </h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form method="post" action="/appcategory/search">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="queryCategoryName" type="text" class="form-control col-md-7 col-xs-12" value="${queryCategoryName }">
                                </div>
                            </div>
                        </li>
...
<%--                                        </c:if>--%>
                        ...
                        <li>
                            ...
                            <a href="/appcategory/addcategory"><button type="button"  class="btn btn-primary">添    加</button></a>
                        </li>
                    </ul>
                </form>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
                                ...
                                <tbody>
                                <c:forEach var="appCategory" items="${appcategoryList }" varStatus="status">
                                    <tr role="row" class="odd">
                                        <td tabindex="0" class="sorting_1">${appCategory.categoryCode}</td>
                                        <td>${appCategory.categoryName }</td>
                                        <td>${appCategory.getParentName() }</td>
                                        <td>
                                            <a href="/appcategory/modify?appCategoryid=${appCategory.id}">
                                                <button type="button" class="btn btn-default checkApp"
                                                        appCategoryid="${appCategory.id }"
                                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="修改分类信息">
                                                    修改
                                                </button>
                                            </a>
                                            <a href="/appcategory/delete?appCategoryid=${appCategory.id}">
                                                <button type="button" class="btn btn-default checkApp"
                                                        appCategoryid="${appCategory.id }"
                                                        data-toggle="tooltip" data-placement="top" title="" data-original-title="删除分类信息">
                                                    删除
                                                </button>
                                            </a>
                                        </td>
...
<script src="${pageContext.request.contextPath }/statics/localjs/appcategorylist.js"></script>
